...
def __deg_to_pulse(deg_from, deg_to, pitch):
    ...
    logger.log(50, '_pul_from, _pul_to, pitch : {} {} {}'.format(_pul_from, _pul_to, pitch))
    logger.log(50, 'diff, divide_num, remainder : {} {} {}'.format(diff, divide_num, remainder))
    logger.log(50, 'deg_from, deg_to :  {} {}'.format(deg_from, deg_to))
    logger.log(50, 'pul_from, pul_to, pitch : {} {} {}'.format(pul_from, pul_to, pitch))
...
def call_service(ch, node_name):
    ...
    try:
        ...
        if response.success:
            ...
            logger.log(50, '[parse_message 1] message {}'.format('parse_message', response.message))
            logger.log(50, '[parse_message 2]  {} {} {} {} {} '.format(node_name, def_from, deg_to, pitch, sleep_sec))
